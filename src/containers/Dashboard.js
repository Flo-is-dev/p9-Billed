...
export default class {
  ...
  handleEditTicket(e, bill, bills) {
    ...
    // * on supprime les écouteurs d'évènement avant d'en ajouter de nouveaux( pour les 4)
    // ? vérifier "handleEditTicket"
    bills.forEach((b) => {
      $(`#open-bill${b.id}`)
        .off("click")
        .click((e) => this.handleEditTicket(e, b, bills));
    });
    ...
    $("#btn-refuse-bill")
      .off("click")
      .click((e) => this.handleRefuseSubmit(e, bill));
  }
